...
function SingleGameInner() {
  ...
  const {
    ...
    sitesState, currentVisit, stealEvents,
    initGame, tickTimer, visitSite, cancelVisit,
    processAITick, clearStealEvent,
  } = useGameStore();
  ...
  const handleVisit = useCallback((siteId: string) => {
    ...
    visitSite(siteId);
  }, [currentVisit, players, myPlayerId, visitSite]);
      ...
      <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
        <div className="max-w-lg w-full bg-gray-900 rounded-2xl p-8 flex flex-col gap-6">
          ...
          <div className="flex gap-3">
            <button
              onClick={() => { initialized.current = false; initGame(aiCount); }}
    ...
    <div className="min-h-screen bg-gray-950 flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden p-3 gap-3">
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-2">
              {filteredSites.map(site => {
                ...
                const isVisitingThis = currentVisit?.siteId === site.id;
                const meVisiting = !!currentVisit && !currentVisit.cancelRequested;
          ...
          {currentVisit && !currentVisit.cancelRequested && (
            <VisitProgress visit={currentVisit} onCancel={cancelVisit} />
          )}
        </div>
