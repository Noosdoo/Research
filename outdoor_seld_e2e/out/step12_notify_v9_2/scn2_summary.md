# 追加5シナリオ 採点（v9.2 run1、ルールv1。2026-07-19、audit5補正）
...
- 通知方向誤差 中央値 7.5°（ほぼ真後ろの音源＝視覚の効かない方向）
