...
- クラス別の可聴フレーム率の予測（発音窓内、吸収・反射無視の点近似）:
    backup_beep: mean=0.63 p10=0.00 完全不可聴率=32.59%
    bike_bell: mean=0.96 p10=0.96 完全不可聴率=1.79%
    car_drive: mean=0.62 p10=0.20 完全不可聴率=1.82%
    crossing: mean=0.80 p10=0.00 完全不可聴率=16.96%
...
- 音量AUCの事前予測（受音レベルのみでのクラス対判別、案A''の事前登録値）:
    backup_beep vs bike_bell: AUC=0.761
    backup_beep vs car_drive: AUC=0.714
    backup_beep vs crossing: AUC=0.605
