# 新規性の再検証サーベイ（2026-07-11 実施。⚠️07-16に更新版あり）

**⚠️2026-07-16注記: 最新の正は out/survey_novelty_update_2026-07-16.md**（must-cite 3件
=PAWS/Sensors2023/6DoF SELD、生き残る新規性4点、禁止表現リスト）。本書は初回調査の記録。
...
1. 「屋外・移動音源SELDの**学習を物理シミュレーションで成立させ**、屋外固有の物理要素
   ...
   ⚠️【未実施 2026-07-15注記】ablation本体は未実行（ゼミ合意待ち）。この主張は
   ablation完了後にのみ使用可
