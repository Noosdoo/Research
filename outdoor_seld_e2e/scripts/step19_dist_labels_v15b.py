# -*- coding: utf-8 -*-
"""v15 の距離付き 6 列ラベル生成 = v13 版 ＋ **距離を水平距離に**（2026-09-04 本人「至近警告は横距離で決めたい」）＋ マイク高さ mic_z。
...
import step11_v15b_render as v15  # noqa: E402  (m9.DS が v15 に切替わる)
from outdoor_seld.labels import frame_label_rows  # noqa: E402

v13 = v15.v13
m9 = v15.m9
V12VAL = "--v12val" in sys.argv
DS = ROOT / "out" / ("dataset_outdoor_siren_v12" if V12VAL else "dataset_outdoor_siren_v15b")
s19.DS = DS
