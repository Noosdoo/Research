# -*- coding: utf-8 -*-
"""v15（v14 ＋ D13 マイク高さ）の生成ドライバ。出力先は out/dataset_outdoor_siren_v15/ のみ。
...
import step11_v15_render as v15  # noqa: E402
...
def main() -> None:
    ...
    assert m9.DS.name == "dataset_outdoor_siren_v15", m9.DS
    if "--list" in sys.argv:
